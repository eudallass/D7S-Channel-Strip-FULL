...
juce::AudioProcessorValueTreeState::ParameterLayout D7SChannelStripFullAudioProcessor::createParameterLayout()
{
    ...
    params.push_back (std::make_unique<juce::AudioParameterFloat>(juce::ParameterID { "editor_width", 1 }, "Editor Width", juce::NormalisableRange<float> (800.0f, 2800.0f, 1.0f), 1400.0f, juce::AudioParameterFloatAttributes().withAutomatable (false).withMeta (true)));
    params.push_back (std::make_unique<juce::AudioParameterFloat>(juce::ParameterID { "editor_height", 1 }, "Editor Height", juce::NormalisableRange<float> (520.0f, 900.0f, 1.0f), 720.0f, juce::AudioParameterFloatAttributes().withAutomatable (false).withMeta (true)));
